...
<body>
    ...
    <div class="company-info">
        ...
        <h3>Why Choose Us</h3>
        <p>
            Avalanche Innovations is a cutting-edge software solutions provider, dedicated to transforming traditional
            business processes into efficient digital workflows. With years of expertise, an excellent history, and a
            team of industry experts, we pride ourselves on delivering customized solutions tailored to our clients'
            unique needs. Partnering with us means:
            .</p>
        <ul>
            <li>Years of Experience and Expertise</li>
            <li>Custom Solution specifically made for YOU</li>
            <li>Adaptability and Future-Ready</li>
            <li>Robust Data Integrity and Security</li>
            <li>Comprehensive Support, including but not limited to training and post-deployment maintenance</li>
            <li>Collaborative and Transparency to ensure YOU are always part of the project</li>
